...
class SprintGame {
    ...
    async draw(value: number): Promise<void> {
        ...
        scoreSection.innerHTML = `<p class="score__box "> Множитель: <span id="multiplier">0</span></p>
        <p class="score__box "> Очки: <span id="score">0</span></p>
        ...
        const wordsContainer: HTMLElement = document.createElement('div');
       ...
       `;
        ...
        buttonContainer.innerHTML = `<button id="btn-right" class="button button--right">Верно</button>
        <button id="btn-false" class="button button--right">Неверно</button> `;
        ...
        // }
        // scoreSection.appendChild(fragment);
